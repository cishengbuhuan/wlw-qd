<template>
	<div class="login-wrap" :style="bg">
		<!--<header>-->
			<!--<span>欢迎登录</span>-->
			<!--<div class="line"></div>-->
			<!--<img class="logo" src="../assets/images/company-logo.png">-->
		<!--</header>-->
		<header></header>
		<div class="content">
			<!-- 文字信息 -->
			...
			.about {
				...
				.about-us {
					...
					.icon {
						width: 50px;
						height: 42px;
						background: url("../assets/images/icon-about-us.png");
				...
				.service {
					.hot-line {
						...
						.icon {
							width: 28px;
							height: 28px;
							background: url("../assets/images/icon-server.png");
							-webkit-background-size: 100% 100%;
							background-size: 100% 100%;
							margin-right: 10px;
						}
					...
					.time {
						...
						.icon {
							width: 20px;
							height: 20px;
							background: url("../assets/images/icon-time.png");
							-webkit-background-size: 100% 100%;
							background-size: 100% 100%;
							margin-right: 15px;
							margin-left: 5px;
