<template>
	<div class="forget-wrap">
		<div class="header">
			<img src="../assets/images/forget-logo.png">
		</div>
		<!-- 找回密码 -->
	...
	.forget-wrap {
		...
		.find-password {
			...
			.progress {
				...
				.verify {
					.step {
						background: url("../assets/images/step1.png");
				...
				.reset {
					.step {
						background: url("../assets/images/step2.png");
						-webkit-background-size: 100% 100%;
						background-size: 100% 100%;
					}
				}
				.finishOne {
					.step {
						background: url("../assets/images/step2-1.png");
						-webkit-background-size: 100% 100%;
						background-size: 100% 100%;
					}
					span {
				...
				.complete {
					.step {
						background: url("../assets/images/step3.png");
						-webkit-background-size: 100% 100%;
						background-size: 100% 100%;
					}
				}
				.finishTwo {
					.step {
						background: url("../assets/images/step3-1.png");
						-webkit-background-size: 100% 100%;
						background-size: 100% 100%;
					}
					span {
