		...
		<div class="content wrap-content">
			...
			<div class="chart">
				...
				<div class="chart-item active">
					...
					<div class="tip">
						<div class="header">
							<div class="icon"><img src="../assets/images/index/icon-active.png"></div>
							<span>激活数</span>
				...
				<div class="chart-item online">
					...
					<div class="tip">
						<div class="header">
							<div class="icon"><img src="../assets/images/index/icon-online.png"></div>
							<span>设备在线数</span>
				...
				<div class="chart-item flow"
					...
					<div class="tip">
						<div class="header">
							<div class="icon"><img src="../assets/images/index/icon-flow.png"></div>
							<span>流量池</span>
					...
					<div class="no-data" v-if="flowData.noData">
						<img src="../assets/images/index/no-pool.png">
					</div>
				</div>
				<!-- 非流量池卡 -->
				<div class="chart-item"
					...
					<div class="tip">
						<div class="header">
							<div class="icon"><img src="../assets/images/index/icon-single.png"></div>
							<span>非共享流量卡(月)</span>
					...
					<div class="no-data" v-if="singleCard.noData">
						<!--贵公司暂无该规格产品-->
						<img src="../assets/images/index/no-single.png">
					</div>
				</div>
			</div>
		</div>
