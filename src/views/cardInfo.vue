	...
	<div class="flowCard-wrap wrap">
		<div class="content wrap-content">
			...
			<div class="page-title">
				<div class="line"></div>
				<span>流量池<span class="small">卡片信息</span></span>
			</div>
			<!-- 表格数据 -->
			<div class="card">
				<!-- tip信息 -->
				<div class="tip">
					<div class="package-name">流量池名称: {{ packageInfo.netWork }} {{ packageInfo.flow }}/{{ packageInfo.type }}</div>
...
<script>
	import {translatePackages,getOnlineStatus,getNetWork,
		getActiveStatus,getGPRS,translateSystem,translateCardKind,baseUrl} from '../assets/base.js'
	export default {
		data() {
			return {
				// 套餐信息
